    ...
    <section className="relative z-10 py-24 bg-gradient-to-r from-[#10E7FF] to-[#38FFCD] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 text-center">
        ...
        <div className="space-y-4">
          <Link
            to="/demo"
            className="group bg-white text-[#001742] font-semibold text-lg px-8 py-4 rounded-2xl hover:bg-gray-100 hover:scale-[1.02] transition-all duration-300 shadow-lg hover:shadow-xl inline-flex items-center gap-3"
          >
